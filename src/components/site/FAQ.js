...
<dl class="row">
  ...
  <dd class="col-sm-9">For players or storytellers to be able to create a secure account 
  and store their various characters, including common attribute values. 
</dd>
<dl class="row"></dl>
  <dt class="col-sm-3">Create, Edit, and Delete Characters</dt>
  <dd class="col-sm-9">
  ...
  <dt class="col-sm-3">Add Real Depth to Your Character Data</dt>
  <dd class="col-sm-9"><p>Each character you create can include a description as elaborate as you would 
  like to make it. Characters can also be assigned to specific campaigns.</p> </dd>

  <dt class="col-sm-3">Character Values that can be stored here include:</dt>
  <dd class="col-sm-9">
    <dl class="row">
    ...
    <dl class="row">
        <dt class="col-sm-4">Abilities (d20 system)</dt>
